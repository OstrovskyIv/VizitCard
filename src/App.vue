...
const t = {
  ru: {
    aboutHeader: "О МОЁМ ПУТИ", stackHeader: "ТЕХНОЛОГИИ", projectsHeader: "ПРОЕКТЫ",
    ...
    projects: [
      ...
      {
        title: "Last Zone: STALKER RP",
        desc: "Атмосферный промо-сайт для ролевого проекта в сеттинге S.T.A.L.K.E.R. Реализована сложная верстка и продвинутые анимации.",
        tags: ["S.T.A.L.K.E.R", "GSAP", "UI/UX"],
        link: "https://github.com/OstrovskyIv/STALKER_ROLE_PLAY"
      },
  ...
  en: {
    aboutHeader: "ABOUT MY PATH", stackHeader: "TECH STACK", projectsHeader: "FEATURED WORK",
    ...
    projects: [
      ...
      {
        title: "Last Zone: STALKER RP",
        desc: "Atmospheric promotional website for a S.T.A.L.K.E.R. RolePlay project. Features complex layouts and advanced animations.",
        tags: ["S.T.A.L.K.E.R", "GSAP", "UI/UX"],
        link: "https://github.com/OstrovskyIv/STALKER_ROLE_PLAY"
      },
  ...
  <div class="h-screen overflow-y-scroll snap-y snap-mandatory bg-[#050505] text-white scroll-smooth relative">
    ...
    <header :class="['fixed top-0 left-1/2 -translate-x-1/2 z-[100] w-full flex flex-col items-center pt-6 transition-all duration-700 pointer-events-none', isHeaderHidden ? '-translate-y-[85%]' : 'translate-y-0']">
      <div class="flex items-center gap-x-3 md:gap-x-6 px-5 md:px-8 py-3 bg-zinc-900/95 border border-white/10 rounded-full shadow-2xl backdrop-blur-md pointer-events-auto">
        ...
        <button @click="currentLang = currentLang === 'ru' ? 'en' : 'ru'" class="text-[10px] md:text-xs font-black text-red-600 hover:text-white uppercase px-1 transition-colors">
        ...
        <div class="flex items-center gap-x-3 md:gap-x-4">
          <a href="https://www.linkedin.com/in/ivan-ostrovsky-3216103b6/" target="_blank" class="text-gray-500 hover:text-[#0077b5] transition-colors">
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
          </a>
          <a href="https://github.com/OstrovskyIv" target="_blank" class="text-gray-500 hover:text-white transition-colors">
          ...
          <a href="https://t.me/Bambuk_lov" target="_blank" class="text-gray-500 hover:text-red-600 transition-colors">
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm5.891 8.146l-1.988 9.33c-.149.675-.548.841-1.115.523l-3.033-2.235-1.463 1.408c-.161.161-.298.298-.611.298l.217-3.091 5.626-5.083c.245-.218-.054-.339-.381-.12l-6.954 4.379-2.997-.938c-.652-.204-.666-.652.136-.964l11.72-4.515c.542-.196 1.017.13 0.842.928z"/></svg>
          </a>
        </div>
      </div>
